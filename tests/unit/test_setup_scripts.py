...
def test_setup_sh_covers_essentials():
    ...
    assert "OPENAI_API_KEY" in text, "下一步应提示默认 OpenAI 所需的 API key"
    assert "AGENT_PROVIDER=qwen" in text, "下一步应说明如何切换到 Qwen"
    assert "DASHSCOPE_API_KEY" in text, "下一步应提示 Qwen 所需的 API key"
